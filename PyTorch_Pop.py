...
dataset = np.loadtxt('/Users/akram/AKRAM_CODE_FOLDER/LLAMA_LLM_CPP/LLM_EXPLORE/pima-indians-diabetes.data.csv', delimiter=',') # split into input (X) and output (y) variables
